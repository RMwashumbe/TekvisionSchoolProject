package com.example.tekvision2.Adapters;
...
import com.example.tekvision2.Helper.ChangeNumberItemsListener;
...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CartListAdapter.ViewHolder holder, int position){
     ...
     holder.feeEachItem.setText("Ksh"+listItemSelected.get(position).getPrice());
     holder.totalEachItem.setText("Ksh" + Math.round((listItemSelected.get(position).getNumberinCart()* listItemSelected.get(position).getPrice())));
